                                    ...
                                    <div class="card-body">
                                        <form action="" method="">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="email" placeholder="nama@gmail.com" />
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <a class="btn btn-primary" href="{{ asset('/dashboard') }}">Login</a>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="{{ asset('/register') }}">Tidak Punya Akun? Daftar Sekarang!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
