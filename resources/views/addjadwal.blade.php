...
<html lang="en">
  <head>
    ...
    <title>Tambah Jadwal Operasional</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control bg-success p-2 text-dark bg-opacity-25" id="formGroupExampleInput2" placeholder="hh.mm">
      </div>
      <div class="mb-3">
        <label for="formGroupExampleInput2" class="form-label">Tujuan</label>
        <input type="text" class="form-control bg-success p-2 text-dark bg-opacity-25" id="formGroupExampleInput2" placeholder="Tujuan">
      </div>     
