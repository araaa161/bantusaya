<!DOCTYPE html>
{{-- jika superadmin jalankan code dibawah --}}
<html lang="en">
    <head>
        <meta charset="utf-8" />
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                                ...
                                <div class="collapse" id="collapseLayouts" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <a class="nav-link" href="{{ asset('/jadwal') }}">Lihat Jadwal operasional</a>
                                        <a class="nav-link" href="{{ asset('/addjadwal') }}">Tambah Jadwal operasional</a>
                                    </nav>
                                </div>
                        </div>
                    </div>
